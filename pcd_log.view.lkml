...
#     datagroup_trigger: monthly
    sql:
      SELECT
        ...
        , CASE WHEN LENGTH("contract1 renewal start issue") between 0 and 3 then null else nullif("contract1 renewal start issue",'') end as "contract1 renewal start issue"
        , CASE WHEN LENGTH("contract1 renewal expire") between 0 and 3 then null else nullif("contract1 renewal expire",'') end as "contract1 renewal expire"
        ...
        , CASE WHEN LENGTH("contract2 renewal start issue") between 0 and 3 then null else nullif("contract2 renewal start issue",'') end as "contract2 renewal start issue"
        , CASE WHEN LENGTH("contract2 renewal expire") between 0 and 3 then null else nullif("contract2 renewal expire",'') end as "contract2 renewal expire"
        ...
        , CASE WHEN LENGTH("contract3 renewal start issue") between 0 and 3 then null else nullif("contract3 renewal start issue",'') end as "contract3 renewal start issue"
        , CASE WHEN LENGTH("contract3 renewal expire") between 0 and 3 then null else nullif("contract3 renewal expire",'') end as "contract3 renewal expire"
        ...
        , CASE WHEN LENGTH("contract4 renewal start issue") between 0 and 3 then null else nullif("contract4 renewal start issue",'') end as "contract4 renewal start issue"
        , CASE WHEN LENGTH("contract4 renewal expire") between 0 and 3 then null else nullif("contract4 renewal expire",'') end as "contract4 renewal expire"
        ...
        , CASE WHEN LENGTH("contract5 renewal start issue") between 0 and 3 then null else nullif("contract5 renewal start issue",'') end as "contract5 renewal start issue"
        , CASE WHEN LENGTH("contract5 renewal expire") between 0 and 3 then null else nullif("contract5 renewal expire",'') end as "contract5 renewal expire"
        ...
        , CASE WHEN LENGTH("contract6 renewal start issue") between 0 and 3 then null else nullif("contract6 renewal start issue",'') end as "contract6 renewal start issue"
        , CASE WHEN LENGTH("contract6 renewal expire") between 0 and 3 then null else nullif("contract6 renewal expire",'') end as "contract6 renewal expire"
        ...
        , CASE WHEN LENGTH("contract7 renewal start issue") between 0 and 3 then null else nullif("contract7 renewal start issue",'') end as "contract7 renewal start issue"
        , CASE WHEN LENGTH("contract7 renewal expire") between 0 and 3 then null else nullif("contract7 renewal expire",'') end as "contract7 renewal expire"
        ...
        , CASE WHEN LENGTH("contract8 renewal start issue") between 0 and 3 then null else nullif("contract8 renewal start issue",'') end as "contract8 renewal start issue"
        , CASE WHEN LENGTH("contract8 renewal expire") between 0 and 3 then null else nullif("contract8 renewal expire",'') end as "contract8 renewal expire"
        ...
        , CASE WHEN LENGTH("contract9 renewal start issue") between 0 and 3 then null else nullif("contract9 renewal start issue",'') end as "contract9 renewal start issue"
        , CASE WHEN LENGTH("contract9 renewal expire") between 0 and 3 then null else nullif("contract9 renewal expire",'') end as "contract9 renewal expire"
